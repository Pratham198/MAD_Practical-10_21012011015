...
class MainActivity : AppCompatActivity() {
    ...
    fun setArraytoListView(){
        ...
        val array = arrayListOf<Person>(
            Person("1","Pratham","pratham12@gmail.com","9856561789","Bayad",90.90,909.90),
            Person("2","Deep","deep12@gmail.com","9647856125","Choila",90.90,909.90),
            Person("3","Parth","prath12@gmail.com","9654832576","Bayad",90.90,909.90),
            Person("4","Het","het12@gmail.com","9657842361","Modasa",90.90,909.90),
            Person("5","Arth","arth12@gmail.com","9543621487","Surat",90.90,909.90)
        )
